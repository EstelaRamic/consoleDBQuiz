...
public class UserMenu {
	...
	public static void Add(int userID, Scanner input){
		...
		Game kontakt = new Game(userID, ime, prezime, br_tel, email, adresa, grad);
		try {
	...
	public static Game azuriraj(int userID, Game kontakt, Scanner input){
		System.out.println();
		...
		Game editKontakt = new Game(kontakt.getId(), userID, ime, prezime, brTel, email, adresa, grad);
		return editKontakt;
	}
}
